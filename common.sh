...
MERKURY_AP_PREAMBLE="Merkury-"
GEENI_AP_PREAMBLE="Geeni-"
COMBINED_AP_PREAMBLE="(${CLOUDCUTTER_AP_PREAMBLE})|(${TUYA_AP_PREAMBLE})|(${IHOME_AP_PREAMBLE})|(${MERKURY_AP_PREAMBLE})|(${GEENI_AP_PREAMBLE})"
